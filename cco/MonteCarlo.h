/*
Header file for general, all-purpose Monte Carlo methods for point patterns/packings
...
// Abstract base class for designing cooling schedule of simulated annealing
